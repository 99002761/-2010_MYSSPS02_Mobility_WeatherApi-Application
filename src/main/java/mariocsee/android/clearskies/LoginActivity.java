...
import mariocsee.android.clearskies.database.DbAccessObj;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pwdEditText = findViewById(R.id.TextPwd);
    ...
    private void startHome() {
        Intent hIntent = new Intent(mariocsee.android.clearskies.LoginActivity.this, MainActivity.class);
